<nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
    <div class="list-group panel">
        <p class="list-group-item siderbar-top" title="" style="background-color: #eee"><img
                src="{{url('images/flarepoint_logo.png')}}" alt=""
                style="display: block; margin-left: auto; margin-right: auto;"></p>
        <a href="{{route('dashboard', \Auth::id())}}" class=" list-group-item" data-parent="#MainMenu"><i
                class="glyphicon sidebar-icon glyphicon-dashboard"></i><span id="menu-txt">{{ __('Dashboard') }}</span>
        </a>
        ...
        <div class="collapse" id="clients">
            ...
            <a href="{{ route('clients.me') }}" class="list-group-item childlist">{{ __('My Clients') }}</a>
        ...
        <div class="collapse" id="contacts">
            ...
            <a href="{{ route('contacts.me')}}" class="list-group-item childlist">{{ __('My Contacts') }}</a>
            <a href="{{ route('contacts.index')}}" class="list-group-item childlist">{{ __('All Contacts') }}</a>
            @if(Entrust::can('contact-create'))
            <a href="{{ route('contacts.create')}}" class="list-group-item childlist">{{ __('New Contact') }}</a>
            @endif
        </div>
        ...
        <div class="collapse" id="tasks">
            <a href="{{ route('tasks.me')}}" class="list-group-item childlist">{{ __('My Tasks') }}</a>
        ...
        <div class="collapse" id="leads">
            <a href="{{ route('leads.me')}}" class="list-group-item childlist">{{ __('My Leads') }}</a>
        ...
        <div class="collapse" id="departments">
            <a href="{{ route('departments.index')}}" class="list-group-item childlist">{{ __('All Departments') }}</a>
            @if(Entrust::hasRole('administrator'))
            <a href="{{ route('departments.create')}}" class="list-group-item childlist">{{ __('New Department') }}</a>
            @endif
        </div>
        ...
        <a href="{{ url('/logout') }}" class=" list-group-item impmenu" data-parent="#MainMenu"><i
                class="glyphicon sidebar-icon glyphicon-log-out"></i><span id="menu-txt">{{ __('Sign Out') }}</span>
        </a>
