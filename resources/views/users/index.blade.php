...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
    {!! Form::open(['route' => ['users.destroy', 'delete'], 'method' => 'delete']) !!}
    <!-- and invalid ID is intentionally set here -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                ...
                <div class="form-group">
                    {{ Form::label('user_clients', __('Choose a new user to assign the clients')) }} <span
                        class="glyphicon glyphicon-exclamation-sign text-danger" data-toggle="tooltip"
                        title="Deleting all clients also deletes ALL tasks and leads assigned to that client, regardless of the user they are assigned to."></span>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="confirm_delete" class="btn btn-success"><span
                        class="glyphicon glyphicon-off"></span> Delete</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
