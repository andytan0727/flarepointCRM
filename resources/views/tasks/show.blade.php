...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        {!! Form::select('user_assigned_id', $users, null, ['class' => 'form-control ui search selection top right
        pointing search-select', 'id' => 'search-select']) !!}
        ...
        <table class="table table_wrapper ">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 5px">{{$invoiceLine->title}}</td>
                    <td style="padding: 5px">{{$invoiceLine->quantity}} </td>
                </tr>
                @endforeach
        ...
        <br />
        <button type="button" {{ $tasks->canUpdateInvoice() == 'true' ? '' : 'disabled'}}
            class="btn btn-primary form-control" value="add_time_modal" data-toggle="modal" data-target="#ModalTimer">
            {{ __('Add time') }}
        </button>
        @if($tasks->invoice)
